...
var Fr = /* @__PURE__ */ __name((e, t, r) => t in e ? _r(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r, "Fr");
var p = /* @__PURE__ */ __name((e, t, r) => Fr(e, typeof t != "symbol" ? t + "" : t, r), "p");
var rt = /* @__PURE__ */ __name((e, t, r) => t.has(e) || At("Cannot " + r), "rt");
var c = /* @__PURE__ */ __name((e, t, r) => (rt(e, t, "read from private field"), r ? r.call(e) : t.get(e)), "c");
var w = /* @__PURE__ */ __name((e, t, r) => t.has(e) ? At("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), "w");
...
var nr = /* @__PURE__ */ __name(async (e, t, r, n, s) => {
...
var Ct = /* @__PURE__ */ __name((e) => (e[sr] = true, e), "Ct");
var ir = /* @__PURE__ */ __name((e) => ({ value: t, children: r }) => {
  if (!r) return;
...
var xe = /* @__PURE__ */ __name((e) => e.values.at(-1), "xe");
var qe = { title: [], script: ["src"], style: ["data-href"], link: ["href"], meta: ["name", "httpEquiv", "charset", "itemProp"] };
var dt = {};
var We = "data-precedence";
var He = /* @__PURE__ */ __name((e) => Array.isArray(e) ? e : [e], "He");
var kt = /* @__PURE__ */ new WeakMap();
var jt = /* @__PURE__ */ __name((e, t, r, n) => ({ buffer: s, context: i }) => {
  if (!s) return;
  const a = kt.get(i) || {};
  kt.set(i, a);
  const o = a[e] || (a[e] = []);
...
var Ie = /* @__PURE__ */ __name((e, t, r) => M(new _(e, r, He(t ?? [])).toString()), "Ie");
var _e = /* @__PURE__ */ __name((e, t, r, n) => {
...
var Kr = /* @__PURE__ */ __name(({ children: e, ...t }) => {
  const r = wt();
  return ["src", "async"].some((n) => !t[n]) || r && xe(r) === "head" ? Ie("script", e, t) : _e("script", e, t, false);
}, "Kr");
var zr = /* @__PURE__ */ __name(({ children: e, ...t }) => ["href", "precedence"].every((r) => r in t) ? (t["data-href"] = t.href, delete t.href, _e("style", e, t, true)) : Ie("style", e, t), "zr");
var Vr = /* @__PURE__ */ __name(({ children: e, ...t }) => ["onLoad", "onError"].some((r) => r in t) || t.rel === "stylesheet" && (!("precedence" in t) || "disabled" in t) ? Ie("link", e, t) : _e("link", e, t, "precedence" in t), "Vr");
var Gr = /* @__PURE__ */ __name(({ children: e, ...t }) => {
  const r = wt();
  return r && xe(r) === "head" ? Ie("meta", e, t) : _e("meta", e, t, false);
}, "Gr");
var or = /* @__PURE__ */ __name((e, { children: t, ...r }) => new _(e, r, He(t ?? [])), "or");
var Xr = /* @__PURE__ */ __name((e) => (typeof e.action == "function" && (e.action = Je in e.action ? e.action[Je] : void 0), or("form", e)), "Xr");
var lr = /* @__PURE__ */ __name((e, t) => (typeof t.formAction == "function" && (t.formAction = Je in t.formAction ? t.formAction[Je] : void 0), or(e, t)), "lr");
var Zr = /* @__PURE__ */ __name((e) => lr("input", e), "Zr");
var Jr = /* @__PURE__ */ __name((e) => lr("button", e), "Jr");
...
var Ye = /* @__PURE__ */ __name((e) => Yr.get(e) || e, "Ye");
...
var Ce = void 0;
var wt = /* @__PURE__ */ __name(() => Ce, "wt");
var Qr = /* @__PURE__ */ __name((e) => /[A-Z]/.test(e) && e.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/) ? e.replace(/([A-Z])/g, "-$1").toLowerCase() : e, "Qr");
...
var rn = /* @__PURE__ */ __name(({ children: e }) => new fr("", { children: e }, Array.isArray(e) ? e : e ? [e] : []), "rn");
function R(e, t, r) {
  let n;
...
var nn = Symbol();
var sn = /* @__PURE__ */ __name(async (e, t = /* @__PURE__ */ Object.create(null)) => {
...
var vn = /* @__PURE__ */ __name((e) => Rt(e, decodeURI), "vn");
...
var it = /* @__PURE__ */ __name((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? Rt(e, pr) : e) : e, "it");
...
var gn = vr;
var yn = /* @__PURE__ */ __name((e, t) => vr(e, t, true), "yn");
var pr = decodeURIComponent;
var Nt = /* @__PURE__ */ __name((e) => Rt(e, pr), "Nt");
var pe;
var N;
var z;
var yr;
...
}, pe = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakSet(), yr = /* @__PURE__ */ __name(function(e) {
  const t = c(this, N)[0][this.routeIndex][1][e], r = P(this, z, vt).call(this, t);
  return r ? /\%/.test(r) ? Nt(r) : r : void 0;
}, "yr"), mr = /* @__PURE__ */ __name(function() {
...
var En = (zt = class {
  ...
  constructor(e, t) {
    ...
    p(this, "html", (e2, t2, r) => {
      const n = /* @__PURE__ */ __name((s) => P(this, X, de).call(this, s, t2, at("text/html; charset=UTF-8", r)), "n");
...
var xn = /* @__PURE__ */ __name((e) => e.text("404 Not Found", 404), "xn");
...
var br = (Vt = class {
  ...
  route(t, r) {
    ...
    return r.routes.map((s) => {
      var a;
      let i;
      r.errorHandler === Mt ? i = s.handler : (i = /* @__PURE__ */ __name(async (o, l) => (await Lt([], r.errorHandler)(o, () => s.handler(o, l))).res, "i"), i[Rn] = s.handler), P(a = n, k, re).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(t) {
  ...
  mount(t, r, n) {
    ...
    const o = /* @__PURE__ */ __name(async (l, f) => {
...
}, D = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakSet(), Rr = /* @__PURE__ */ __name(function() {
...
}, "Rr"), H = /* @__PURE__ */ new WeakMap(), re = /* @__PURE__ */ __name(function(t, r, n) {
...
}, "re"), ze = /* @__PURE__ */ __name(function(t, r) {
  if (t instanceof Error) return this.errorHandler(t, r);
  throw t;
}, "ze"), Ve = /* @__PURE__ */ __name(function(t, r, n, s) {
...
}, Z = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), Re = /* @__PURE__ */ new WeakSet(), Pr = /* @__PURE__ */ __name(function() {
...
}, "Pr"), Ar = /* @__PURE__ */ __name(function(e) {
  const t = [];
  let r = e === C;
...
}, Q = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ new WeakMap(), Ee = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakSet(), ne = /* @__PURE__ */ __name(function(e, t, r, n) {
  const s = [];
...
var be = void 0;
var Mn = /* @__PURE__ */ __name(() => be, "Mn");
var B = /* @__PURE__ */ __name((e) => "t" in e, "B");
...
var Ht = /* @__PURE__ */ __name((e, t) => be && e instanceof SVGElement && /[A-Z]/.test(t) && (t in e.style || t.match(/^(?:o|pai|str|u|ve)/)) ? t.replace(/([A-Z])/g, "-$1").toLowerCase() : t, "Ht");
  ...
  for (let s in t) {
    ...
    if (s !== "children" && (!r || r[s] !== i)) {
      ...
      if (a) {
        ...
        let o;
        typeof i == "function" ? o = i(e) || (() => i(null)) : i && "current" in i && (i.current = e, o = /* @__PURE__ */ __name(() => i.current = null, "o")), gt.set(e, o);
      } else if (s === "style") {
        const o = e.style;
...
var kr = /* @__PURE__ */ __name((e, t, r, n, s) => {
  var i, a;
...
var _n = /* @__PURE__ */ __name((e, t) => !!(e && e.length === t.length && e.every((r, n) => r[1] === t[n][1])), "_n");
var Xe = /* @__PURE__ */ new WeakMap();
var yt = /* @__PURE__ */ __name((e, t, r) => {
  var i, a, o, l, f, u;
  const n = !r && t.pC;
  r && (t.pC || (t.pC = t.vC));
  let s;
  try {
    ...
    if (g) {
      const v = /* @__PURE__ */ __name(() => Ze([0, false, e[2]], m), "v"), E = Xe.get(m) || [];
      E.push(v), Xe.set(m, E);
      const b = g(h, () => {
        const x = Xe.get(m);
        if (x) {
...
var Bt = [];
var Ze = /* @__PURE__ */ __name(async (e, t) => {
  e[5] || (e[5] = []);
  const r = Pe.get(t);
  r && r[0](void 0);
  let n;
...
var Bn = /* @__PURE__ */ __name((e, t, r) => ({ tag: ke, props: { children: e }, key: r, e: t, p: 1 }), "Bn");
var lt = 0;
var Lr = 1;
var ct = 2;
var ft = 3;
...
var qn = /* @__PURE__ */ __name((e) => {
  var a;
  const t = /* @__PURE__ */ __name(() => typeof e == "function" ? e() : e, "t"), r = je.at(-1);
  if (!r) return [t(), () => {
  }];
...
var St = /* @__PURE__ */ __name((e, t) => Kn(() => (r) => {
  let n;
...
var Ue = /* @__PURE__ */ Object.create(null);
var Fe = /* @__PURE__ */ __name((e, t, r, n, s) => {
...
var Xn = /* @__PURE__ */ __name((e) => !e || ["src", "async"].some((t) => !e[t]) ? { tag: "script", props: e, type: "script", ref: e.ref } : Fe("script", e, 1, false, true), "Xn");
var Zn = /* @__PURE__ */ __name((e) => !e || !["href", "precedence"].every((t) => t in e) ? { tag: "style", props: e, type: "style", ref: e.ref } : (e["data-href"] = e.href, delete e.href, Fe("style", e, 2, true, true)), "Zn");
var Jn = /* @__PURE__ */ __name((e) => !e || ["onLoad", "onError"].some((t) => t in e) || e.rel === "stylesheet" && (!("precedence" in e) || "disabled" in e) ? { tag: "link", props: e, type: "link", ref: e.ref } : Fe("link", e, 1, "precedence" in e, true), "Jn");
var Yn = /* @__PURE__ */ __name((e) => Fe("meta", e, void 0, false, false), "Yn");
var Mr = Symbol();
var Qn = /* @__PURE__ */ __name((e) => {
  const { action: t, ...r } = e;
...
var Dr = /* @__PURE__ */ __name((e, { formAction: t, ...r }) => {
...
// ../.wrangler/tmp/bundle-tQNEBr/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-tQNEBr/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.12641882466871102.mjs.map
